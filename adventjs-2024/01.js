...
function prepareGifts(gifts) {
  const filteredGiftsSet = new Set(gifts);
  const filteredGiftsArray = Array.from(filteredGiftsSet); 
  const sortedFilteredGifts = filteredGiftsArray.sort((a,b) => a - b);
  return sortedFilteredGifts;
}
